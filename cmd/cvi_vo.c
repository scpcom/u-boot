...
static int do_startvo(struct cmd_tbl *cmdtp, int flag, int argc, char * const argv[])
{
	...
	if (panel_name != NULL) {
		...
		} else if (strcmp(panel_name,"milkv_8hd_2lane") == 0) { // 8 inch
			panel_desc.panel_name = "MILKV_8HD-800x1280-2LANE";
			panel_desc.dev_cfg = &dev_cfg_milkv_8hd_800x1280_2lane;
			panel_desc.hs_timing_cfg = &hs_timing_cfg_milkv_8hd_800x1280_2lane;
			panel_desc.dsi_init_cmds = dsi_init_cmds_milkv_8hd_800x1280_2lane;
			panel_desc.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_milkv_8hd_800x1280_2lane);
		} else if (strcmp(panel_name,"milkv_st7796s") == 0) { // 4 inch
			panel_desc.panel_name = "MILKV_ST7796S-320x480";
			panel_desc.dev_cfg = &dev_cfg_milkv_st7796s_320x480;
			panel_desc.hs_timing_cfg = &hs_timing_cfg_milkv_st7796s_320x480;
			panel_desc.dsi_init_cmds = dsi_init_cmds_milkv_st7796s_320x480;
			panel_desc.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_milkv_st7796s_320x480);
		...
		} else if ((strcmp(panel_name,"st7701_dxq5d0019_v0") == 0) ||
			   (strcmp(panel_name,"st7701_dxq5d0019_V0") == 0)) { // 5inch-new
		...
		} else if (strcmp(panel_name,"st7701_hd228001c31_alt0") == 0) { // 2.28 inch
			panel_desc.panel_name = "ST7701-368x552";
			panel_desc.dev_cfg = &dev_cfg_st7701_368x552_alt0;
			panel_desc.hs_timing_cfg = &hs_timing_cfg_st7701_368x552_alt0;
			panel_desc.dsi_init_cmds = dsi_init_cmds_st7701_368x552_alt0;
			panel_desc.dsi_init_cmds_size = ARRAY_SIZE(dsi_init_cmds_st7701_368x552_alt0);
		...
		} else if ((strcmp(panel_name,"d240si31") == 0) ||
			   (strcmp(panel_name,"st7701_lct024bsi20") == 0)) { // 2.4 inch // g
